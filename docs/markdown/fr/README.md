...
- [User-Guide-fr.md](User-Guide-fr.md)  
  Guide utilisateur complet (traduction du User-Guide original).

- [Ma-premiere-utilisation-de-la-digigurdy.md](Ma-premiere-utilisation-de-la-digigurdy.md)  
  Guide d’initiation très simplifié pour une première prise en main.

- [FAQ-fr.md](FAQ-fr.md)  
  Foire aux questions (30 questions/réponses courantes).

- [Depannage-plus-de-son.md](Depannage-plus-de-son.md)  
  Guide de dépannage en cas de perte de son (plus de son, mode MIDI vs audio, etc.).

## Objectif

Cette arborescence a pour but :
